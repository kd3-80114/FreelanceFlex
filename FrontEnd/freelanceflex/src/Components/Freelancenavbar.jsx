...
//     {/* Logo */}
//     <Link className='navbar-brand' to='/freelancer/freelancerhome'>
//       FreelanceFlex
//     </Link>
...
//       <Link className='nav-link' aria-current='page' to='/freelancer/freelancerhome'>
//         Home
//       </Link>
//     </li> */}
//     <Link className='nav-link' aria-current='page' to='/freelancer/vieworders'>
//         Orders
//       </Link>
...
//     <Link className='nav-link' aria-current='page' to='/freelancer/viewprofile'>
//         Profile
//       </Link>
//     <li className='nav-item'>
